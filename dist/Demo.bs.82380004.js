...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/bs-platform/lib/es6/caml_builtin_exceptions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.undefined_recursive_module = exports.assert_failure = exports.sys_blocked_io = exports.stack_overflow = exports.match_failure = exports.not_found = exports.division_by_zero = exports.end_of_file = exports.invalid_argument = exports.failure = exports.sys_error = exports.out_of_memory = void 0;
var out_of_memory =
/* tuple */
["Out_of_memory", 0];
...
var Caml_builtin_exceptions = _interopRequireWildcard(require("bs-platform/lib/es6/caml_builtin_exceptions.js"));
...
exports.Style = Style;
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","bs-platform/lib/es6/caml_builtin_exceptions.js":"../node_modules/bs-platform/lib/es6/caml_builtin_exceptions.js"}],"../node_modules/bs-platform/lib/es6/caml_array.js":[function(require,module,exports) {
"use strict";
...
var Caml_builtin_exceptions = _interopRequireWildcard(require("./caml_builtin_exceptions.js"));
...
/* No side effect */
},{"./caml_array.js":"../node_modules/bs-platform/lib/es6/caml_array.js"}],"../node_modules/reason-react/src/ReasonReactOptimizedCreateClass.js":[function(require,module,exports) {
"use strict";
...
exports.createClass = exports.reactNoopUpdateQueue = exports.factory = exports.emptyObject = void 0;
...
var ReactPropTypeLocationNames; // if (process.env.NODE_ENV !== 'production') {
...
var factory = function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
  ...
  function validateTypeDef(Constructor, typeDef, location) {
    for (var propName in typeDef) {// if (typeDef.hasOwnProperty(propName)) {
  ...
  function validateMethodOverride(isAlreadyDefined, name) {
    ...
    if (ReactClassMixin.hasOwnProperty(name)) {} // _invariant(
    ...
    if (isAlreadyDefined) {// _invariant(
      ...
      if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
        ...
        if (shouldAutoBind) {
          ...
          if (isAlreadyDefined) {
            ...
            proto[name] = property; // if (process.env.NODE_ENV !== 'production') {
  ...
  function mixStaticSpecIntoComponent(Constructor, statics) {
    ...
    for (var name in statics) {
      ...
      var isReserved = name in RESERVED_SPEC_KEYS; // _invariant(
      //   !isReserved,
      ...
      var isInherited = name in Constructor; // _invariant(
      //   !isInherited,
  ...
  function bindAutoBindMethod(component, method) {
    var boundMethod = method.bind(component); // if (process.env.NODE_ENV !== 'production') {
  ...
  function createClass(spec) {
    ...
    var Constructor = identity(function (props, context, updater) {
      ...
      var initialState = this.getInitialState ? this.getInitialState() : null; // if (process.env.NODE_ENV !== 'production') {
      //   // We allow auto-mocks to proceed as if they're returning null.
      //   if (
...
exports.Router = exports.reducerComponentWithRetainedProps = exports.reducerComponent = exports.statelessComponentWithRetainedProps = exports.statelessComponent = void 0;
...
var ReasonReactOptimizedCreateClass = _interopRequireWildcard(require("./ReasonReactOptimizedCreateClass.js"));
...
function convertPropsIfTheyreFromJs(props, jsPropsToReason, debugName) {
  ...
  if (match == null) {
    if (jsPropsToReason !== undefined) {
      return (
        /* Element */
        [Curry._1(jsPropsToReason, props)]
      );
    } else {
      throw [Caml_builtin_exceptions.invalid_argument, "A JS component called the Reason component " + (debugName + " which didn't implement the JS->Reason React props conversion.")];
    }
  } else {
    return match;
  }
...
function createClass(debugName) {
  return ReasonReactOptimizedCreateClass.createClass({
    ...
    getInitialState: function () {
      ...
      return {
        reasonState: Curry._1(convertedReasonProps[0][
        /* initialState */
        10],
        /* () */
        0)
    ...
    componentDidMount: function () {
      ...
      var self = $$this.self(curReasonState, component[
      /* retainedProps */
      11]);
    ...
    componentDidUpdate: function (prevProps, prevState) {
      ...
      5] !== anyToUnit) {
        ...
        var newSelf = $$this.self(curReasonState, newComponent[
        /* retainedProps */
        11]);
        var oldSelf_000 =
        /* handle */
        ...
        [oldSelf_000,
        /* state */
        prevReasonState, oldSelf_002, oldSelf_003, oldSelf_004];
        return Curry._1(newComponent[
        /* didUpdate */
        5],
        /* record */
        [
    ...
    componentWillUnmount: function () {
      ...
      6] !== anyToUnit) {
        Curry._1(component[
        /* willUnmount */
        6], $$this.self(curReasonState, component[
        /* retainedProps */
        11]));
      }
    ...
    componentWillUpdate: function (nextProps, nextState) {
      ...
      7] !== anyToUnit) {
        ...
        var newSelf = $$this.self(nextReasonState, newComponent[
        /* retainedProps */
        11]);
        var oldSelf_000 =
        /* handle */
        ...
        [oldSelf_000,
        /* state */
        curReasonState, oldSelf_002, oldSelf_003, oldSelf_004];
        return Curry._1(newComponent[
        /* willUpdate */
        7],
        /* record */
    ...
    componentWillReceiveProps: function (nextProps) {
      ...
      3] !== willReceivePropsDefault) {
        ...
        return thisJs.setState(function (curTotalState, param) {
          var curReasonState = curTotalState.reasonState;
          var oldSelf = $$this.self(curReasonState, oldComponent[
          /* retainedProps */
          11]);

          var nextReasonState = Curry._1(newComponent[
          /* willReceiveProps */
          3], oldSelf);
    ...
    handleMethod: function (callback) {
      ...
      return function (callbackPayload) {
        ...
        var curReasonState = curState.reasonState;
        var convertedReasonProps = convertPropsIfTheyreFromJs(thisJs.props, thisJs.jsPropsToReason, debugName);
        return Curry._2(callback, callbackPayload, $$this.self(curReasonState, convertedReasonProps[0][
        /* retainedProps */
        11]));
      };
    },
    sendMethod: function (action) {
      ...
      12] !== reducerDefault) {
        ...
        var partialStateApplication = Curry._1(component[
        /* reducer */
        12], action);
    ...
    render: function () {
      ...
      var curState = thisJs.state;
      var curReasonState = curState.reasonState;
      return Curry._1(created[
      /* render */
      9], $$this.self(curReasonState, created[
      /* retainedProps */
      11]));
    }
  });
...
function basicComponent(debugName) {
  return (
    ...
    debugName,
    /* reactClassInternal */
    createClass(debugName),
    /* handedOffState : record */
    [
    /* contents */
    undefined],
    /* willReceiveProps */
    willReceivePropsDefault,
    /* didMount */
    anyToUnit,
    /* didUpdate */
    anyToUnit,
...
function wrapJsForReason(reactClass, props, children) {
  var jsElementWrapped = function (param, param$1) {
    ...
    var varargs =
    /* array */
    [reactClass$1, props$2].concat(children$1);
...
var Router = [push, watchUrl, unwatchUrl, url];
/* dummyInteropComponent Not a pure module */

exports.Router = Router;
},{"bs-platform/lib/es6/curry.js":"../node_modules/bs-platform/lib/es6/curry.js","react":"../node_modules/react/index.js","bs-platform/lib/es6/caml_builtin_exceptions.js":"../node_modules/bs-platform/lib/es6/caml_builtin_exceptions.js","./ReasonReactOptimizedCreateClass.js":"../node_modules/reason-react/src/ReasonReactOptimizedCreateClass.js"}],"App.bs.js":[function(require,module,exports) {
"use strict";
...
var ReasonReact = _interopRequireWildcard(require("reason-react/src/ReasonReact.js"));
...
function make(param) {
  return (
    ...
    /* render */
    function (param) {
      return React.createElement("h1", undefined, "Hello Worldy");
    },
    /* initialState */
    component[
    /* initialState */
...
},{"react":"../node_modules/react/index.js","reason-react/src/ReasonReact.js":"../node_modules/reason-react/src/ReasonReact.js"}],"Demo.bs.js":[function(require,module,exports) {
"use strict";

var ReactDOMRe = _interopRequireWildcard(require("reason-react/src/ReactDOMRe.js"));

var ReasonReact = _interopRequireWildcard(require("reason-react/src/ReasonReact.js"));

var App$SparcelyUnreasonable = _interopRequireWildcard(require("./App.bs.js"));

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

// Generated by BUCKLESCRIPT VERSION 4.0.7, PLEASE EDIT WITH CARE
ReactDOMRe.renderToElementWithId(ReasonReact.element(undefined, undefined, App$SparcelyUnreasonable.make(
/* array */
[])), "root");
...
/*  Not a pure module */
},{"reason-react/src/ReactDOMRe.js":"../node_modules/reason-react/src/ReactDOMRe.js","reason-react/src/ReasonReact.js":"../node_modules/reason-react/src/ReasonReact.js","./App.bs.js":"App.bs.js"}],"../node_modules/parcel-bundler/lib/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/lib/builtins/hmr-runtime.js","Demo.bs.js"], null)
//# sourceMappingURL=/Demo.bs.82380004.map